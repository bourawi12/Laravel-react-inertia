...
import AuthenticatedLayout from "/home/bouraoui/laravel11-react-inertia/resources/js/Layouts/AuthenticatedLayout.jsx";
...
export default function Index({auth, projects, queryParams = null,success}) {
    ...
    const deleteProject =(project)=>{
        if (!window.confirm('are you sure you want to dlete the project')){
            return;
        }
                                        ...
                                        {projects.data.map(project => (
                                            <tr key={project.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td className="px-3 py-2">
                                                    <img src={project.image_path} style={{height:100}} alt={`Image of ${project.name}`} />
                                                </td>
                                                <th className="px-3 py-2 text-white hover:underline">
                                                {console.log(route("project.show", project.id))}
                                                ...
                                                <td className="px-3 py-2">{project.createdBy ? project.createdBy.name : 'Unknown'}</td>
                                                <td className="px-3 py-2 text-nowrap">
