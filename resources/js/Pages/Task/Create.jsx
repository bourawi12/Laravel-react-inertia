    ...
    <AuthenticatedLayout
      ...
      header={
        <div className="flex justify-between items-center">
          ...
          <Link href={route('task.create')} className="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1">Edit</Link>
        </div>
      }
    >
      <Head title="Tasks" />
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            >
              ...
              <div className="mt-4">
                <InputLabel htmlFor="task_priority" value="Assigned User" />
